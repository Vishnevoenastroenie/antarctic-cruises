...
var _burgerMenu = require("./modules/burger-menu/burger-menu");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    window.form = form;
    form.init();
    var burger = new _burgerMenu.Burger();
    burger.init();
  });
});
...
},{"./modules/burger-menu/burger-menu":2,"./modules/form-validate/form":4,"./modules/map/map":10,"./modules/modals/init-modals":11,"./utils/ios-vh-fix":15}],2:[function(require,module,exports){
"use strict";
...
exports.activateMapOnScroll = activateMapOnScroll;
var destination = [59.938631, 30.323037];
var map = document.querySelector('#map');
var link = 'https://api-maps.yandex.ru/2.1/?apikey=7c70a677-2343-4514-aa84-bc38e108561a&lang=ru_RU';
...
var createScriptLink = function createScriptLink() {
...
function activateMapOnScroll() {
  if (map) {
    if (map.getBoundingClientRect().top - window.innerHeight < 2000 && !executed) {
      executed = true;
      createScriptLink();
      ymapsScript.addEventListener('load', function () {
